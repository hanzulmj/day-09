...
export default function Home(){
    return(
      ...
      <Text variant="bodyMedium" styles={styles.body}> Video provides a powerful way to help you prove your point. 
        ...
        the video you want to add. You can also type a keyword to search online for the video that best fits your document.
...
you can add a matching cover page, header, and sidebar. Click Insert and then choose 
...
layout options appears next to it. When you work on a table, click where you want to add a row or a column,
